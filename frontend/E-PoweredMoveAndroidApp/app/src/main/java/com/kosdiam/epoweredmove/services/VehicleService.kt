...
import com.kosdiam.epoweredmove.services.interfaces.IVehicleService
import okhttp3.OkHttpClient
import retrofit2.Retrofit
import retrofit2.converter.gson.GsonConverterFactory

class VehicleService(tokenId: String? = "") {
    ...
    private val retrofit: Retrofit = Retrofit.Builder()
        ...
        .build()
    val vehicleService: IVehicleService = retrofit.create(IVehicleService::class.java)
}